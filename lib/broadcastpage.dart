        ...
        children: <Widget>[
          Container(
            ...
            decoration: BoxDecoration(
                image:
                    DecorationImage(image: AssetImage('assets/xpert_icon.png')),
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: Padding(
                        ...
                        child:
                            Text('Train bot', style: TextStyle(fontSize: 10.0)),
                      ),
                    ),
                  ],
                ),
                      ...
                      child: Center(
                        child: Column(
                          ...
                          children: <Widget>[
                            IconTheme(
                              data:
                                  IconThemeData(color: Colors.grey, size: 90.0),
                              child: Icon(Icons.network_check),
                            ),
                            SizedBox(height: 20.0),
                            Text('BROADCAST YOUR MESSAGES',
                                textAlign: TextAlign.center,
                                style: TextStyle(fontSize: 35.0)),
                            Text(
                                'Reach out to your followers with messages in their chats and get their responses.',
                                textAlign: TextAlign.center,
                                style: TextStyle(color: Colors.grey))
                          ],
                        ),
