                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                              ...
                              Row(
                                children: <Widget>[
                                  Container(
                                    ...
                                    height: 30.0,
                                    child: Image(
                                      image: creatorData["payment_type"].toString().toLowerCase() == 'upi'
                                          ? AssetImage('assets/upi.png')
                                          : AssetImage('assets/paytm.jpeg'),
                                      fit: BoxFit.contain,
                                    ),
                                  ),
                                  Text(creatorData["payment_type"]??'Not set',
                                      style: TextStyle(
                              ...
                              GestureDetector(
                                onTap: () {
                                  Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                          builder: (context) => EditPayMethod(userDocId: widget.userDocId, creatorSetDocId: widget.creatorDocId,)));
                                },
                                child: Text('Change',
                                    style: TextStyle(
                        ...
                        SizedBox(height: 8.0),
                        Text(
                          creatorData["payment_details_id"]??'No payment id given',
                          style: TextStyle(color: Colors.black, fontSize: 22.0),
                        ),
                        Divider(
                          height: 5.0,
                              ...
                              children: <Widget>[
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    image: DecorationImage(image: AssetImage('assets/view_transactions.png'))
                                  ),
                                ),
                                Padding(
                                  ...
                                  child: Text('VIEW TRANSACTIONS',
                                      style:
                                          TextStyle(color: Colors.amber, fontSize: 19.0)),
                                ),
                              ],
                            ),
                          ),
