                        ...
                        children: <Widget>[
                          ...
                          Container(
                            ...
                            child: Text('of their annual',
                                style: TextStyle(
                                    color: Colors.amber, fontSize: 22.0)),
                          ),
                          Container(
                            width: MediaQuery.of(context).size.width * 0.65,
                            child: Text('income',
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        padding: const EdgeInsets.only(left: 4.0),
                        child: Text(
                            'Get 5% of their Xpert income in the first year',
                            textAlign: TextAlign.start,
                            maxLines: 3,
                            softWrap: true,
                            style:
                        ...
                        Container(
                          ...
                          child: IconTheme(
                            ...
                            child: IconButton(
                              ...
                              onPressed: () {
                                Share.share(
                                    "Join me on XPERT! The #1 Social Learning App. It's a great way to share your knowledge. XPERT is Invite-Only . Use my invite code : " +
                                        widget.refCode +
                                        " to signup. Download : " +
                                        "http://bit.ly/2R3WkO9",
