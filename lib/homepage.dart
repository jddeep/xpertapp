...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin {
  ...
  String _questionAsked = 'If the onChanged callback is null or the list of items is null then the dropdown button will be disabled, i.e. its arrow will be displayed in grey and it will not respond to input. A disabled button will display the disabledHint widget if it is non-null.';
  ...
  Widget _questionCard() {
    ...
    child: Column(
      children: <Widget>[
        ...
        _isCardScrollable?SingleChildScrollView(
        ...
        _isCardScrollable?Container():Align(
          ...
          child: Row(
            children: <Widget>[
              Padding(
                ...
                child: _isPopularQuestion? Stack(children: <Widget>[
                  CircleAvatar(
                  radius: 25.0,
              ...
              _isPopularQuestion?Container():Padding(
            ...
            child: Column(
              children: <Widget>[
                Container(
                  ...
                  child: _isCardScrollable?_questionCard(): TinderSwapCard(
                ...
                _isCardScrollable?Container():Text(
