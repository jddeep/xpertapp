          ...
          Navigator.push(
            ...
            MaterialPageRoute(
              builder: (context) => OTPScreen(
                  widget.cameras, signInWithPhoneNumber, -2), // Not registerd yet
            ),
          );
        });
      } else {
        if (docs.documents[0].data['status'] == 'in-review') {
          print("UnderReview Profile");
          // verifyPhone();
          verifyPhone().whenComplete((){
            Navigator.pushReplacement(
              context,
              MaterialPageRoute( // status code 0
                builder: (context) => OTPScreen(
                  widget.cameras, signInWithPhoneNumber, 0), //UnderReview Profile
              ));
          });
          ...
          verifyPhone().whenComplete((){
            Navigator.pushReplacement(
              context,
              MaterialPageRoute( // status code -1
                builder: (context) => OTPScreen(
                  widget.cameras, signInWithPhoneNumber, -1), //UnderReview Profile
              ));
          });
        } else if (docs.documents[0].data['status'] == 'closed') {
